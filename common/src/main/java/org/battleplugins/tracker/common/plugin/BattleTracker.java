package org.battleplugins.tracker.common.plugin;
...
import org.battleplugins.tracker.common.plugin.*;
...
public final class BattleTracker extends BattlePlugin {
    ...
    public void onDisable() {
        ...
        try {
            for (MemberRepository memberRepository : trackerManager.getInterfaces().values()) {
