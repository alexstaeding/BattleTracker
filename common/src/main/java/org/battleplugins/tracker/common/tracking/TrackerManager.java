...
public class TrackerManager {
    ...
    private Map<String, MemberRepository> interfaces;
     ...
     */
    public Optional<MemberRepository> getInterface(String interfaceName) {
     ...
     */
    public MemberRepository getPvPInterface() {
     ...
     */
    public MemberRepository getPvEInterface() {
     ...
     */
    public void addInterface(String interfaceName, MemberRepository memberRepository) {
       interfaces.put(interfaceName, memberRepository);
    }
     ...
     */
    public Map<String, MemberRepository> getInterfaces() {
